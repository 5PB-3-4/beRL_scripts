...
### 2024/01/06
- 次回の更新では.dllファイルやanmファイルの配布場所を[Releases](https://github.com/5PB-3-4/beRL_scripts/releases)に変更し、mainのリポジトリで置かれているものは簡易説明やソースコードといたします。理由としまして、過去のコードのバックアップを保存したいからです。度重なる変更にご迷惑をおかげします。
